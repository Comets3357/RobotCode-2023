...
private:
    ...
    const double mpsToRpm = ((60.0/1.0)*(39.3701/1.0)*(1.0/(4.25*M_PI))*(4.0/1.0)); // 40:10 for actual comp bot
    const double ticksToMeters = (1.0/4.0)*(4.0*M_PI/1.0)*(1.0/39.3701)*(39.3701/42.3701);
